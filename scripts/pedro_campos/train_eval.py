...
def main():
    ...
    kfold_eval(
        ...
        n_splits=10, train_name="mlp_baseline"
    )
    ...
    test_eval(
        ...
        base_model_builder_fn=Classifier, 
        best_params=best_params_mlp, train_name="mlp_baseline"
    )
    
    best_params_mlp_restricted = get_best_hyperparameters(db_path=DB_PATH, study_name="MLP_Restricted")
    best_params_mlp_restricted['n_neurons'] = 6
    
    kfold_eval(
        X_df=X_train, y_series=y_train, 
        base_model_builder_fn=Classifier, 
        best_params=best_params_mlp_restricted, 
        n_splits=10, train_name="mlp_restricted"
    )
